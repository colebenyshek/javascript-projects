...
// Create object list of menu items
const menu = [
    {
        id: 1,
...
const displayMenuButtons = function () {
    ...
    // Map unique categories into Button HTML
    ...
    // Use currentTarget.dataset and Array.prototype.filter()
...
// Create array of unique categories only
function uniqueCategories(menuItems) {
    let unique = ["all"];
    for (const item of menuItems) {
        if (!unique.find(e => e === item.category)) {
